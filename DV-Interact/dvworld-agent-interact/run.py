...
def config() -> argparse.Namespace:
    ...
    # example config
    parser.add_argument("--test_path","-t", type=str, default="../tasks/dv-interact.jsonl")
    ...
    parser.add_argument("--user_config_path", type=str, default="../user_config/user.json", help="Path to user simulator config (fact_source/table_schema) to merge by instance_id.")
