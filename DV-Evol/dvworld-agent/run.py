...
def config() -> argparse.Namespace:
    ...
    parser.add_argument("--suffix", '-s', type=str, default="evol-0121-echarts")
    
    parser.add_argument("--model", type=str, default="gemini-3-pro-preview-new")    #gemini-3-pro-preview-new    gpt-5.2-2025-12-11   openai_qwen3-vl-32b-instruct  
    ...
    # example config
    parser.add_argument("--test_path","-t", type=str, default="/Users/bytedance/Documents/DVSheet-1/DV-Evol/tasks/dv-evolution.jsonl")
    ...
    parser.add_argument(
        "--viz_lang",
        choices=["python", "echarts", "vega-lite", "d3.js", "plotly.js"],
        default="echarts",
        help="Visualization target language for DV-Evol outputs.",
    )
    ...
    parser.add_argument("--type", "-k", type=str, default="dv-evol", 
                       help="Filter tasks by prefix (e.g., 'dvsheet-create', 'dvsheet-fix', 'dvsheet-dashboards', 'dv-evol') or 'all'. Comma-separated allowed.")
